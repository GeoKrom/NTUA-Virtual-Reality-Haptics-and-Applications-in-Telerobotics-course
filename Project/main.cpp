...
void drawUpperArm()
{
    ...
    // Περιστροφή του άνω βραχίονα γύρω από τον ώμο
    glRotatef(
        -shoulderAngle,
        0.0f,
        1.0f,
    ...
    // Μετακίνηση στο κέντρο του συνδέσμου
    glTranslatef(
        L1 / 2.0f,
        0.0f,
        0.0f
...
void drawForearm()
{
    ...
    // Η συνάρτηση καλείται ήδη στο elbow.
    // Εδώ εφαρμόζεται μόνο η σχετική γωνία του αγκώνα.
...
void drawGripper()
{
    ...
    // Η συνάρτηση καλείται ήδη στο elbow
    // και έχει εφαρμοστεί η γωνία του αγκώνα
    // από το drawRobot().
